...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        self.setViewControllers([gradesController, coursesController, profileController], animated: false)
        ...
        for x in 0..<tabItems.count {
            tabItems[x].imageInsets = UIEdgeInsets(top: 5, left: 0, bottom: 0, right: 0)
            tabItems[x].title = ""
        }
    }
}
...
extension UITabBarController {
    ...
    func createNavController(vc: UIViewController, tabBarImage: UIImage) -> UINavigationController {

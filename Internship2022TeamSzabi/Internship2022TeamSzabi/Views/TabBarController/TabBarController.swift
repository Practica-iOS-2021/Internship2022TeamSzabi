...
final class TabBarController: UITabBarController {
    override func viewDidLoad() {
        ...
        let gradesController = createNavController(rootViewController: GradesViewController(),
                                                   tabBarImage: UIImage(named: "grades-tabbar-icon"))
        let coursesController = createNavController(rootViewController: CoursesViewController(),
                                                    tabBarImage: UIImage(named: "courses-tabbar-icon"))
        let profileController = createNavController(rootViewController: ProfileViewController(),
...
private extension TabBarController {
    ...
    func createNavController(rootViewController: UIViewController,
                             tabBarImage: UIImage?) -> UINavigationController {
